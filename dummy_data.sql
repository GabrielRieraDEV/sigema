...
INSERT INTO usuario (id, nombre, apellido, cargo, username, password_hash, perfil, activo) VALUES
(1, 'Administrador', 'Sistema', 'Admin', 'admin', '$2b$12$CZoTqToi1kNhh8Ob.qkEX.uguuuKxUoNk2waPKXlbnYfN2HCKHxmC', 'Administrador', true)
ON CONFLICT (id) DO NOTHING;
